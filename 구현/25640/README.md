...
<p>진호는 요즘 유행하는 심리 검사인 MBTI에 관심이 많다. MBTI는 아래와 같이 네 가지 척도로 사람들의 성격을 구분해서, 총 $16$가지의 유형중에서 자신의 유형을 찾을 수 있는 심리 검사이다.
...
### 입력 
 ...
 <p>첫째 줄에 진호의 MBTI 유형이 주어진다.

둘째 줄에 진호의 친구의 수 $N(1\le N \le 100)$이 주어진다.

셋째 줄부터 $N$개의 줄에 친구들의 MBTI 유형이 주어진다.</p>
